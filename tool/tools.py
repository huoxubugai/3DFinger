...
camera_a_inner_para_resize = np.mat([[483.76885985, 0, 351.5636866, 0],
                                     [0, 483.96969605, 175.50937805, 0],
                                     [0, 0, 1, 0]])
camera_b_inner_para_resize = np.mat([[481.64959715, 0, 294.90611455, 0],
                                     [0, 481.37112425, 206.26220275, 0],
                                     [0, 0, 1, 0]])
camera_c_inner_para_resize = np.mat([[483.7043457, 0, 306.39131765, 0],
                                     [0, 484.03793335, 225.8683143, 0],
                                     [0, 0, 1, 0]])
camera_d_inner_para_resize = np.mat([[480.5434265, 0, 346.3641218, 0],
                                     [0, 480.3063354, 208.7187581, 0],
                                     [0, 0, 1, 0]])
camera_e_inner_para_resize = np.mat([[477.7441406, 0, 365.15282625, 0],
                                     [0, 476.8794861, 225.75589835, 0],
                                     [0, 0, 1, 0]])
camera_f_inner_para_resize = np.mat([[481.03897095, 0, 297.6251611, 0],
                                     [0, 480.54992675, 198.41948045, 0],
                                     [0, 0, 1, 0]])
# 将图片resize为640*400后的投影矩阵
all_camera_projection_mat_resize = [
